        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '15px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <div style={{ backgroundColor: ENTERPRISE_GREEN, padding: '8px 12px', borderRadius: '4px 0 0 4px' }}>
                <span style={{ color: 'white', fontSize: '24px', fontWeight: '700', fontStyle: 'italic' }}>e</span>
              </div>
              <div style={{ backgroundColor: ENTERPRISE_BLACK, border: `1px solid ${ENTERPRISE_GREEN}`, borderLeft: 'none', padding: '8px 15px', borderRadius: '0 4px 4px 0' }}>
                <span style={{ color: 'white', fontSize: '18px', fontWeight: '700', letterSpacing: '1px' }}>enterprise</span>
              </div>
            </div>
